...
function HeroSection() {
  ...
  return (
    ...
    >
      <img src={assets.marvelLogo} alt="" className="maz-h-11 lg:h-11 mt-20" />
      <h1 className="text-5xl md:text-[70px] md:leading-18 font-semibold max-w-100">
      ...
      <div className="flex items-center gap-4 text-gray-300">
        ...
        <div className="flex items-center gap-1">
          <Clock className="w-4.5,h-4.5" /> 2h 8min
        </div>
      </div>
      <p className="max-w-md text-gray-300">In a post-apocalyptic word where cities ride on wheels and consume each other to survive,
      ...
      transition rounded-full font-medium cursor-pointer">Explore Movies
