...
const DateSelect = ({ dateTime, id }) => {
  return (
    <div id="dateselect" className="pt-30">
      <div
        className="flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/10 
      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center gap-6 text-sm mt-5">
            ...
            <span className="grid gird-col-3 md:flex flex-wrap md:max-w-lg gap-4">
